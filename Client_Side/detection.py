...
class Detection(QThread):
    ...
    def run(self):
        ...
        # Starts camera (WINDOWS İÇİN DÜZELTİLMİŞ HALİ)
        # Buraya cv2.CAP_DSHOW ekledik ki laptop kamerasını açabilsin
    ...
    def save_detection(self, frame):
        # Klasör adını saved_frame olarak ayarladık
